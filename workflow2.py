...
#############################################---- Name list ----########################################################
########################################################################################################################
def get_namelist(done_path, output_path):
    """Get namelist file."""
    ...
    outputs = [output_path + 'name_list.txt']
    options = {'cores': 1, 'memory': "20g", 'walltime': "1:00:00", 'account':"Dypsis_Chloroplast_Phylogeny"}

    spec = """
    cd /home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/
    ls > name_list0.txt
    sed '1d' name_list0.txt > name_list.txt
    rm -r name_list0.txt
    """
...
#############################################---- Seq lengths ----######################################################
########################################################################################################################
def seq_lenghts(done_path, output_path):
    """Get the sequence lengths."""
    inputs = [done_path + 'namelist.txt']
    outputs = [output_path + 'seq_lengths.txt']
    options = {'cores': 1, 'memory': "20g", 'walltime': "1:00:00", 'account':"Dypsis_Chloroplast_Phylogeny"}

    spec = """
    cd /home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/
    python /home/sarahe/HybPiper/get_seq_lengths.py /home/sarahe/GitHub/BSc/Target_filer/Renamed_Target_file3.fasta /home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/name_list.txt dna > seq_lengths.txt
    """
...
def stats_summary(seq_len_path):
    ...
    spec = """
    cd /home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/
    python /home/sarahe/HybPiper/hybpiper_stats.py /home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/seq_lengths.txt /home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/name_list.txt > stats.txt
    """
...
gwf.target_from_template('sequence_length'), seq_lenghts(done_path = '/home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/',
                                                        output_path = '/home/sarahe/Dypsis_Chloroplast_Phylogeny/BSc/01_HybPiper/done/')
